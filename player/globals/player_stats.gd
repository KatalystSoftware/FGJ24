...
const MAX_HEALTH_GROWTH_RATE = 0.3
const MOVEMENT_SPEED_GROWTH_RATE = 0.1
const EXPERIENCE_MULTIPLIER_GROWTH_RATE = 0.2
const SHOT_AMOUNT_GROWTH_RATE = 1
const SHOT_DAMAGE_GROWTH_RATE = 0.1
const SHOT_COOLDOWN_GROWTH_RATE = 0.1
const SHOT_SPEED_GROWTH_RATE = 0.25
const SHOT_LIFETIME_GROWTH_RATE = 0.25
